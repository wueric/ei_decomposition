...
from lib.util_fns import unpad_basis_post_decomp
...
if __name__ == '__main__':
    ...
    # pad the EIs
    padded_eis_by_cell_id = {cell_id : np.pad(upsampled_ei, [(0, 0), (args.before, args.after)])
                                       for cell_id, upsampled_ei in eis_by_cell_id.items()}
    ...
    # pad the basis
    padded_basis = np.pad(initial_basis, [(0, 0), (args.before, args.after)])
    ...
    with open(args.output_pickle, 'wb') as joint_fit_file:
        ...
        pickle_dict = {
            'decomposition': unpad_basis_post_decomp(decomposition_dict,
